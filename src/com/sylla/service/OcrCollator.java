...
public class OcrCollator {
	...
	static {
		...
		codeFrame.setTitle("Image OCR text collator!");
	...
	public static String getCode(final byte[] data, String text) {
		...
		synchronized(COMPONENT_LOCK) {
			...
			Dimension d0 = new Dimension(w + 204, h + 2);
			Dimension d1 = new Dimension(200, h);
