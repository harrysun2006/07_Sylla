...
JNIEXPORT jdouble JNICALL Java_com_sylla_Ocr_add(JNIEnv *env, jobject obj, jdouble x, jdouble y)
{
	return x + y;
}

JNIEXPORT jdouble JNICALL Java_com_sylla_Ocr_sub(JNIEnv *env, jobject obj, jdouble x, jdouble y)
{
	return x - y;
}

JNIEXPORT jdouble JNICALL Java_com_sylla_Ocr_mul(JNIEnv *env, jobject obj, jdouble x, jdouble y)
{
	return x * y;
}

JNIEXPORT jdouble JNICALL Java_com_sylla_Ocr_div(JNIEnv *env, jobject obj, jdouble x, jdouble y)
{
	return x / y;
}

JNIEXPORT void JNICALL Java_com_sylla_Ocr_winocr(JNIEnv *env, jobject obj, jstring name)
{
	ocr(_T("E:\\Projects\\SZGSW\\Sylla\\images\\b0000013.jpg"));
	/*
  ...
  for(int i = 0; i < count; i++ )
  {
		...
		env->CallVoidMethod(ocrImage, text, NewJString(env, "test"));
		env->CallVoidMethod(ocrImage, accurate, (jdouble) 100);
